        ...
        <div class="authentication-wrapper authentication-basic container-p-y">
            ...
            <div class="card">
                ...
                <div class="app-brand justify-content-center">
                    ...
                    <img src="{{asset('admin/assets/img/layouts/download.png')}}" width="130" height="130">
                ...
                @csrf
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="email" @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
                        @error('email')
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="remember-me"> Ingatkan </label>
                        </div>
                    </div>
                    <div class="mb-3">
