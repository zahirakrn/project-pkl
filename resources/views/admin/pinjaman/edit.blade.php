...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Table/</span> Pinjaman</h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('pinjaman.update', $pinjaman->id) }}" method="POST">
                        ...
                        <select name="id_barang" class="form-control">
                            ...
                            @foreach ($barang as $item)
                                <option value="{{ $item->id }}"
                                    {{ $item->id == $pinjaman->id_barang ? 'selected' : '' }}>{{ $item->nama_barang }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-fullname">Tanggal Pinjaman</label>
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="basic-default-name" placeholder="Tanggal Pinjam"
                            name="tanggal_pinjam" value="{{ $pinjaman->tanggal_pinjam }}" />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="basic-default-name" placeholder="Nama Peminjam"
                            name="nama_peminjam" value="{{ $pinjaman->nama_peminjam }}" />
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="basic-default-name" placeholder="Jumlah"
                            name="jumlah" value="{{ $pinjaman->jumlah }}" />
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row justify-content-end">
                    <div class="col-sm-10">
                        <a href="{{ route('pinjaman.index') }} " class="btn btn-primary">Back</a>
