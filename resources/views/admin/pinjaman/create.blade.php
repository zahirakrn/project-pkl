...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Table/</span> Pinjam</h4>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('pinjaman.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-default-fullname">Tanggal Pinjam</label>
                    <div class="col-sm-10">
