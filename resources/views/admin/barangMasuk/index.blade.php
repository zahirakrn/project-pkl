...
@endsection
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tables /</span> barangMasuk</h4>
    <div class="card">
        <div class="card-body">
                                    ...
                                    <form action="{{ route('barangmasuk.destroy', $data->id) }}" method="POST">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="{{ route('barangmasuk.edit', $data->id) }}"><i
                                                        class="bx bx-edit-alt me-1"></i> Edit </a>
                                                <a href="{{ route('barangmasuk.destroy', $data->id) }}" class="dropdown-item"
